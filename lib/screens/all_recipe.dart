      ...
      body: FutureBuilder(future: ConstantFunction.getResponse(recipe),
       builder:(context,snapshot){
        ...
        child: GridView.builder(
          ...
          mainAxisSpacing: 1,crossAxisSpacing: 10,childAspectRatio: .6/1
          ),
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(flex: 1,child: Padding(padding:const EdgeInsets.only(top: 8,left: 6),
